...
class GameBoard(tk.Frame):
    def __init__(self, parent, rows=8, columns=8, size=32, color1="white", color2="red"):
...
if __name__ == "__main__":
    ...
    board.addpiece("player1", player1, 0,1)
    board.addpiece("player2", player1, 0,3)
    board.addpiece("player3", player1, 0,5)
    board.addpiece("player4", player1, 0,7)

    board.addpiece("player5", player1, 1,0)
    board.addpiece("player6", player1, 1,2)
    board.addpiece("player7", player1, 1,4)
    board.addpiece("player8", player1, 1,6)

    board.addpiece("player9", player1, 2,1)
    board.addpiece("player10", player1, 2,3)
    board.addpiece("player11", player1, 2,5)
    board.addpiece("player12", player1, 2,7)
